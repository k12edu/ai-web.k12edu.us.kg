  ...
  methods: {
    ...
    async create_new_conversation() {
      try {
        ...
        const response = await fetch(`https://ai.k12edu.us.kg/api/v1/chats/b4dbf55cc1c911ef80f40242c0a89006/sessions`, {
          method: 'POST',
          headers: {
    ...
    async send_message_to_backend() {
      ...
      try {
        ...
        const url = 'https://ai.k12edu.us.kg/api/v1/chats/b4dbf55cc1c911ef80f40242c0a89006/completions';
